...
- 🔭 I’m currently working on [Azerconnect LLC](https://github.com/AzDigitalLab) and trying to learn `PostgreSQL` and `Java Spring Framework` to become `Fullstack Flutter Developer`
